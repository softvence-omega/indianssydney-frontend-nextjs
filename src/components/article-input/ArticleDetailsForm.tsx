...
//   const [additionalFieldType, setAdditionalFieldType] = useState<any | "">("");
...
//         [fieldKey]: {
//           ...formData.additionalFields[fieldKey as any],
//           value: res as string,
//         },
//       },
//     });
...
//       additionalFields: {
//         ...formData.additionalFields,
//         [fieldKey]: { ...formData.additionalFields[fieldKey as any], value },
//       },
//     });
//   };

//   const handleRemoveAdditionalField = (fieldKey: string) => {
//     const { [fieldKey as any]: removed, ...rest } = formData.additionalFields;
//     onUpdate({ additionalFields: rest });
//   };

//   const renderAdditionalFieldInput = (fieldKey: string, field: any) => {
...
//                     onUpdate({
//                       subCategoryId: value,
//                       subcategorysslug: selectedSubCat?.slug || "",
//                     });
//                   }}
...
//                 id="shortQuote"
//                 className="w-full rounded-none shadow-none"
//                 placeholder="Write a qoute for your article"
