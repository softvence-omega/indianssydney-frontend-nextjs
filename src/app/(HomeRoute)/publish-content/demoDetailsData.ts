export const demoDetailsData = {
  ...
  contentType: "VIDEO",
    ...
    shortQuote: "Nest (NestJS) is a framework for building efficient, scalable Node.js server-side applications. It uses progressive JavaScript, is built with and fully supports TypeScript (yet still enables developers to code in pure JavaScript)",
    image:
    ...
    audioFile: "https://github.com/rafaelreis-hotmart/Audio-Sample-files/raw/master/sample.mp3",
    ...
    user: {
      ...
      profilePhoto: "https://www.example.com/images/john-doe-profile.jpg",
    },
    category: {
