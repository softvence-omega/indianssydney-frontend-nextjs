...
//   const [updateArticle] = useEditContentMutation();
...
//         ? articleData.data.tags.split(",").map((tag) => tag.trim())
//         : [];
...
//       handleAdditionalFieldUpdate(index, res.url);
...
//       uploadedData.append("id", formData.id || "");
...
//       const result = await updateArticle(id,uploadedData);
...
import { Textarea } from "@/components/ui/textarea";
import { ArrowLeft, Divide, Plus, Upload, X } from "lucide-react";
import uploadFileInAws from "@/utils/fileUploader";
import { useGetAllCategoryQuery } from "@/store/features/category/category.api";
import {
  useEditContentMutation,
