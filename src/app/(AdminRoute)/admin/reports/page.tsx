...
const reportsData = [
  ...
  },
  {
    ...
    reason: "Another sample reason for demonstration purposes in the reporting system."
  },
  {
    id: 4,
    profile: "Mike Johnson",
    content: "Test Content",
    reason: "This is a test content report with a longer reason to show text wrapping capabilities."
  }
];
    ...
    <div className="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="lg:hidden space-y-4">
          {reportsData.map((report) => (
            <div key={report.id} className="bg-white rounded-lg shadow p-4 sm:p-6">
              <div className="space-y-3">
                <div>
                  <h3 className="text-sm font-medium text-gray-500 uppercase tracking-wider">Profile</h3>
                  <p className="mt-1 text-sm font-medium text-gray-900">{report.profile}</p>
                </div>
                ...
                <div>
                  <h3 className="text-sm font-medium text-gray-500 uppercase tracking-wider">Reason</h3>
        ...
        {reportsData.length === 0 && (
          <div className="bg-white rounded-lg shadow p-8 text-center">
            ...
            <p className="text-gray-500">There are no reports to display at this time.</p>
          </div>
        )}
      </div>
    </div>
